...
var infoHtml = `
<div style="display: inline">Kursalarm bei: <input id="alarm" oninput="onInput()" type="number" step="any" style="margin-right: 7px"><span id="check">&#10003;</span><button style="display: inline" id="saveAlarm" onclick="updateAlarm()">Speichern</button></div>
`;

function initialize() {
	let wknElement = document.querySelector(".item-data > span:nth-child(4)");
	headlineElement = document.querySelector("#chart h2");
	currentValueElement = document.querySelector("span[class='value']");
